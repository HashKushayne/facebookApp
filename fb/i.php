...
$fb = new Facebook([
  'app_id' => '419060261800950',
  'app_secret' => '3878457dfab03c77497de9c48a1dcb92',
...
if (isset($accessToken)) {
    ...
    try {
		...
		if(isset($_POST['insert'])){
     	$data = ['source' => $fb->fileToUpload(__DIR__.'/photo.jpeg'), 'message' => 'Check out this app! It is awesome http://localhost/fb/i.pnp '];
...
<form method="post"><center><input type="submit" name="insert" class="button" value=""/></center></form>
	...
	<h1 class="warning"><b><?php echo $name." is your enemy!"; ?></b></h1>
    <section><div class="loader"></div><div class="loader2"></div><div class="images" style="position:relative;left:0;"><?php echo "<img src='".$picture['url']."' class='you' id='you' /><img src='kill_cross.png'  width='400' height='300' class='cross' id='cross'/><img src='blackboard.png'  width='550' height='350' class='blackboard' id='blackboard'/> <p class='content' id='content' style='color:white;'><b>What you did: $selected_reason <br> Where you did it: $selected_country <br> </b></p>"; ?></div></section>
